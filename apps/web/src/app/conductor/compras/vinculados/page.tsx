...
export default function ConductorComprasVinculadosPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <Link href="/conductor/compras" className="text-sm font-medium text-indigo-700">
          ← Lista de compra
        </Link>
      ...
      <ul className="space-y-4">
        {purchaseAggregates.map((r) => (
          <li key={r.productId} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <Link href={`/conductor/compras/${r.productId}`} className="mt-3 inline-block text-sm font-semibold text-indigo-700">
