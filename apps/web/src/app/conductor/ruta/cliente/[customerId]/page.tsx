...
export default function ConductorEntregaClientePage() {
  ...
  if (!c) {
    return (
      <div className="space-y-2">
        ...
        <Link href="/conductor/ruta" className="text-indigo-700">
          Volver a ruta
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href="/conductor/ruta" className="text-sm font-medium text-indigo-700">
          ← Ruta
        </Link>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <button
          type="button"
          onClick={() => router.push(`/conductor/cobros/registrar?cliente=${customerId}`)}
