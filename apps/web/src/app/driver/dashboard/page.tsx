  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Link
          href="/driver/compras/vinculados"
          className="rounded-full border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-800"
        >
          Pedidos vinculados
        </Link>
        <Link href="/driver/compras/en-vivo" className="rounded-full border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium">
          Compra en vivo
        </Link>
        <Link href="/driver/ruta" className="rounded-full border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium">
          Ruta del día
        </Link>
        <Link href="/driver/cobros/registrar" className="rounded-full border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium">
          Registrar cobro
        </Link>
        <Link href="/driver/resumen" className="rounded-full border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium">
          Resumen / cierre
        </Link>
        <Link href="/driver/incidencias" className="rounded-full border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium">
          Incidencia
        </Link>
      </div>
    </div>
